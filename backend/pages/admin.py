...
class QuarterAdmin(admin.ModelAdmin):
    ...
    ordering = ('-created_at',)
    exclude = ('user',)  # 🔹 Oculta o campo no formulário

    def save_model(self, request, obj, form, change):
        if not obj.pk:
            obj.user = request.user  # 🔹 Atribui o utilizador logado
    ...
    #         return qs
    #     return qs.filter(user=request.user)  # 🔹 Só mostra os próprios objetos
