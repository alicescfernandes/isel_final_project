(()=>{var l=Object.create;var h=Object.defineProperty;var d=Object.getOwnPropertyDescriptor;var c=Object.getOwnPropertyNames;var u=Object.getPrototypeOf,p=Object.prototype.hasOwnProperty;var v=(s=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(s,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):s)(function(s){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+s+'" is not supported')});var f=(s,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of c(t))!p.call(s,r)&&r!==e&&h(s,r,{get:()=>t[r],enumerable:!(i=d(t,r))||i.enumerable});return s};var g=(s,t,e)=>(e=s!=null?l(u(s)):{},f(t||!s||!s.__esModule?h(e,"default",{value:s,enumerable:!0}):e,s));var b="http://localhost:8000/api/",n=class extends HTMLElement{constructor(){super(),this.id=`chart_${Math.floor(Math.random()*1e6)}`,this.state={chartSlug:this.getAttribute("chart_slug"),quarterNumber:this.getAttribute("q"),isError:!1,isLoading:!0}}static get observedAttributes(){return["chart_slug"]}connectedCallback(){this.setupLazyLoad()}fetchData(){let t=new URLSearchParams;t.set("slug",this.state.chartSlug),t.set("q",this.state.quarterNumber),this.state.selectedOption&&t.set("opt",this.state.selectedOption),fetch(`${b}chart/?${t.toString()}`).then(e=>{if(!e.ok)throw new Error(`HTTP error! Status: ${response.status}`);return e.json()}).then(e=>{let{selected_option:i,...r}=e;this.setState({selectedOption:i||"",...r})}).catch(()=>{this.setState({isError:!0})}).finally(()=>{this.setState({isLoading:!1})})}setState(t){this.state={...this.state,...t},this.render()}renderQuarterNavigation(){let t=this.querySelector(`#${this.id} .chart-quarter-navigation`),{quarter:e}=this.state;t.innerHTML=`
        ...
        <button ${!e.next&&"disabled"} aria-label="Next Quarter" class="next-quarter disabled:text-gray-100 text-gray-500 text-xl">\u2192</button>`}renderSpinner(){this.innerHTML=`<div role="status" class="h-full flex justify-center items-center">
