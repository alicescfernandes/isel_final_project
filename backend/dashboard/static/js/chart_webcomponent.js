(()=>{var C=Object.defineProperty;var d=Object.getOwnPropertySymbols;var m=Object.prototype.hasOwnProperty,y=Object.prototype.propertyIsEnumerable;var g=(s,e,t)=>e in s?C(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t,c=(s,e)=>{for(var t in e||(e={}))m.call(e,t)&&g(s,t,e[t]);if(d)for(var t of d(e))y.call(e,t)&&g(s,t,e[t]);return s};var f=(s,e)=>{var t={};for(var r in s)m.call(s,r)&&e.indexOf(r)<0&&(t[r]=s[r]);if(s!=null&&d)for(var r of d(s))e.indexOf(r)<0&&y.call(s,r)&&(t[r]=s[r]);return t};var v=(s,e,t)=>new Promise((r,i)=>{var l=n=>{try{o(t.next(n))}catch(h){i(h)}},a=n=>{try{o(t.throw(n))}catch(h){i(h)}},o=n=>n.done?r(n.value):Promise.resolve(n.value).then(l,a);o((t=t.apply(s,e)).next())});var b=`${window.location.origin}/api/`,p=class extends HTMLElement{constructor(){super(),this.initState(),this.id=`chart_${this.state.chartSlug}`}initState(){this.state={chartSlug:this.getAttribute("chart_slug"),quarterNumber:this.getAttribute("q"),isError:!1,isLoading:!0}}static get observedAttributes(){return["chart_slug"]}connectedCallback(){this.setupLazyLoad()}fetchData(){return v(this,null,function*(){let e=new URLSearchParams(c({slug:this.state.chartSlug,q:this.state.quarterNumber},this.state.selectedOption&&{opt:this.state.selectedOption}));try{let r=yield fetch(`${b}chart/?${e.toString()}`);if(!r.ok)throw new Error(`HTTP error! Status: ${r.status}`);let t=yield r.json(),{selected_option:l}=t,a=f(t,["selected_option"]);this.setState(c({selectedOption:l||""},a))}catch(r){this.setState({isError:!0})}finally{this.setState({isLoading:!1})}})}setState(e){this.state=c(c({},this.state),e),this.render()}renderSpinner(){return`<div class="spinner-container" role="status">
